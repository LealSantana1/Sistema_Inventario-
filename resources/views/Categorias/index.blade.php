            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        <a class="btn btn-primary text-white" href="{{ route('admin.categorias.create') }}">Crear nueva Categorias</a>
                        <a class="btn btn-success text-white" href="{{ route('categorias.pdf') }}" target="_blank">Generar PDF</a>
                    </p>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success text-white" href="{{ route('admin.categorias.edit', $categoria->id) }}">Editar</a>
